  ...
  const getPickups = async () => {
    try {
      ...
      if (res?.data) {
        ...
        console.log('delivery data', res.data.detail);
                ...
                <TouchableOpacity
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <View style={{ width: '50%' }}>
                      ...
                      <Text style={Styles.orderId}>Order Types</Text>
                      <Text style={Styles.orderIdNumber}>
                        {item.payment_mode}
                      </Text>
                    </View>
                    <View style={{ width: '50%' }}>
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        copyToClipboard(item.customer_phone_number);
                      }}>
                      <Image
                        source={Copy}
                        style={{
